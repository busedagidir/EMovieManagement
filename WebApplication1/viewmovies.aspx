<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="viewmovies.aspx.cs" Inherits="WebApplication1.viewmovies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <center>
                    <h3> Movie Inventory List </h3>
                </center>
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <asp:Panel class="alert alert-success" role="alert" Visible="false" ID="Panel1" runat="server">
